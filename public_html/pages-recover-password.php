						...
						<form id="reset" method="post">
							<div class="form-group mb-none">
								<div class="input-group">
									<input name="username" id="email" type="email" placeholder="E-mail" class="form-control input-lg" required autocomplete="off"/>
	...
	$("#reset").on("submit",function(e)
{
	...
	var email=$("#email").val();
	// $.ajax({
	// 	url:"reset_password_email.php",
	// 	method:"post",
	// 	datatype:"JSON",
	// 	data:{email:email},
	// 	success:function(data){
	// 		if(data['success']='true')
	// 		alert("check your email,link has been mailed you");
	// 	}
	// });
	 window.location.href = 'reset_new_password.php?emailid='+email;
	 alert("ok");
